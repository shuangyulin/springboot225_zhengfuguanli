  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='所在单位' prop="danweiTypes">
                 <el-select v-model="ruleForm.danweiTypes" disabled placeholder='请选择所在单位'>
                     <el-option
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.danweiTypes)&& 'yonghu'==this.flag){
